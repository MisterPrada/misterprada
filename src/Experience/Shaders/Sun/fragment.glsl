...
void main()
{
    ...
    //gl_FragColor.rgb	= vec3( f * ( 0.75 + brightness * 0.3 ) * orange ) + corona * orange * orangeRed;
...
//    }
    ...
    float alpha = 1.0 - smoothstep(0.29, .5, dist); // compute alpha value based on distance
