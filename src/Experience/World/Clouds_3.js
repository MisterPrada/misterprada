...
export default class Clouds_3 extends Model {
    ...
    setModel() {
        const clouds_object = this.resources.items.clouds3Attribute

        // create geometry
        const geometry = new THREE.InstancedBufferGeometry()
        geometry.instanceCount = 395
        ...
        const material = this.material = new THREE.ShaderMaterial( {
            uniforms: {
                ...
                uFade: new THREE.Uniform( 0.922 ),
                uRandomSize: new THREE.Uniform( new THREE.Vector3( -0.2, 0.37, 0.48 ) ),
                uRotateSpeed: new THREE.Uniform( 0.016 ),
                uStarBrightness: new THREE.Uniform( 1.08 ),
            },
