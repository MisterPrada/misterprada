...
export default class Points_2 extends Model {
    ...
    setModel() {
        this.source = this.resources.items.points2Model
        ...
        const material = this.material = new THREE.ShaderMaterial( {
            uniforms: {
                ...
                uAlpha: new THREE.Uniform( 2.32 ),
                uRotateSpeed: new THREE.Uniform( 0.025 ),
                uScale: new THREE.Uniform( -0.63 ),
            },
