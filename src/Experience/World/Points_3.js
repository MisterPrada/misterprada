...
export default class Points_3 extends Model {
    ...
    setModel() {
        this.source = this.resources.items.points3Model
        ...
        const material = this.material = new THREE.ShaderMaterial( {
            uniforms: {
                ...
                uAlpha: new THREE.Uniform( 5.29 ),
                uRotateSpeed: new THREE.Uniform( 0.101 ),
                uScale: new THREE.Uniform( 1.36 ),
            },
